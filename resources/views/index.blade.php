  ...
  <div class="table-wrapper">
    <div class="table-title">
      <div class="row">
        ...
        <div class="col-sm-6">
          <a href="{{ route('rooms.create') }}" class="btn btn-danger"><i class="material-icons">&#xE147;</i> <span>Ajouter nouvelle chambre</span></a>
        </div>
      </div>
    </div>
    ...
    <table class="table table-striped table-sm">
      <thead>
        <tr>
          ...
          <th scope="col">Adultes max</th>
          <th scope="col">Enfants max</th>
